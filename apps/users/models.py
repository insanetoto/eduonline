...
class UserProfile(AbstractUser):
    ...
    mobile = models.CharField(max_length=11, verbose_name=u"手机号码", blank=True, null=True)
...
class Banner(models.Model):
    ...
    images = models.ImageField(upload_to="banner/%Y/%m", verbose_name=u"轮播图", max_length=100)
